...
export default class LanguageProvider extends Disposable {
	...
	private async registerProviders(): Promise<void> {
		...
		await Promise.all([
			...
			import('./languageFeatures/refactor').then(provider => this._register(provider.register(selector, this.client, cachedNavTreeResponse, this.fileConfigurationManager, this.commandManager))),
