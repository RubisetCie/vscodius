...
export class ExtensionGalleryService extends AbstractExtensionGalleryService {
	...
	constructor(
		...
		super(storageService, requestService, logService, environmentService, fileService, productService, configurationService, allowedExtensionsService);
	}
}
...
export class ExtensionGalleryServiceWithNoStorageService extends AbstractExtensionGalleryService {
	...
	constructor(
		...
		super(undefined, requestService, logService, environmentService, fileService, productService, configurationService, allowedExtensionsService);
	}
}
