...
import { adoptToGalleryExtensionId, areSameExtensions, getGalleryExtensionId } from './extensionManagementUtil.js';
...
import { asJson, asTextOrError, IRequestService } from '../../request/common/request.js';
...
export abstract class AbstractExtensionGalleryService implements IExtensionGalleryService {
	...
	private async getLatestRawGalleryExtension(extension: string, uri: URI, token: CancellationToken): Promise<IRawGalleryExtension | null> {
		...
		try {
			...
			return await asJson<IRawGalleryExtension>(context);
		}
...
export class ExtensionGalleryService extends AbstractExtensionGalleryService {
	...
	constructor(
		...
		super(storageService, requestService, logService, environmentService, fileService, productService, configurationService, allowedExtensionsService, extensionGalleryManifestService);
	}
}
...
export class ExtensionGalleryServiceWithNoStorageService extends AbstractExtensionGalleryService {
	...
	constructor(
		...
		super(undefined, requestService, logService, environmentService, fileService, productService, configurationService, allowedExtensionsService, extensionGalleryManifestService);
	}
}
