...
suite('Config Remotes', () => {
	...
	test('HTTPS remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('https://github.com/RubisetCie/vscodius.git'), allowedDomains), ['github.com']);
	...
	test('SCP-like remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('git@github.com:RubisetCie/vscodius.git'), allowedDomains), ['github.com']);
	...
	test('Multiple remotes', function () {
		const config = ['https://github.com/RubisetCie/vscodius.git', 'https://git.example.com/gitproject.git'].map(remote).join('');
	...
	test('Non allowed domains are anonymized', () => {
		const config = ['https://github.com/RubisetCie/vscodius.git', 'https://git.foobar.com/gitproject.git'].map(remote).join('');
	...
	test('HTTPS remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('https://github.com/RubisetCie/vscodius.git')), ['github.com/RubisetCie/vscodius.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('https://github.com/RubisetCie/vscodius.git'), true), ['github.com/RubisetCie/vscodius']);
		...
		assert.deepStrictEqual(getRemotes(remote('https://github.com/RubisetCie/vscodius.git'), true), getRemotes(remote('https://github.com/RubisetCie/vscodius')));
	...
	test('SCP-like remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('git@github.com:RubisetCie/vscodius.git')), ['github.com/RubisetCie/vscodius.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:RubisetCie/vscodius.git'), true), ['github.com/RubisetCie/vscodius']);
		...
		// Compare Striped .git with no .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:RubisetCie/vscodius.git'), true), getRemotes(remote('git@github.com:RubisetCie/vscodius')));
	...
	test('Multiple remotes to be hashed', function () {
		const config = ['https://github.com/RubisetCie/vscodius.git', 'https://git.example.com/gitproject.git'].map(remote).join(' ');
		assert.deepStrictEqual(getRemotes(config), ['github.com/RubisetCie/vscodius.git', 'git.example.com/gitproject.git']);

		// Strip .git
		assert.deepStrictEqual(getRemotes(config, true), ['github.com/RubisetCie/vscodius', 'git.example.com/gitproject']);

		// Compare Striped .git with no .git
		const noDotGitConfig = ['https://github.com/RubisetCie/vscodius', 'https://git.example.com/gitproject'].map(remote).join(' ');
