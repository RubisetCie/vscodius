...
export abstract class AbstractFileSynchroniser extends AbstractSynchroniser {
	...
	constructor(
		...
		super(syncResource, collection, fileService, environmentService, storageService, userDataSyncStoreService, userDataSyncBackupStoreService, userDataSyncEnablementService, logService, configurationService, uriIdentityService);
...
export abstract class AbstractJsonFileSynchroniser extends AbstractFileSynchroniser {
	...
	constructor(
		...
		super(file, syncResource, collection, fileService, environmentService, storageService, userDataSyncStoreService, userDataSyncBackupStoreService, userDataSyncEnablementService, logService, configurationService, uriIdentityService);
	}
