...
export abstract class ViewPane extends Pane implements IView {
	...
	protected renderBody(container: HTMLElement): void {
		this.viewWelcomeController = this._register(new ViewWelcomeController(container, this, this.instantiationService, this.openerService, this.contextKeyService));
	}
