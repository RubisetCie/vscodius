...
export class TerminalInstance extends Disposable implements ITerminalInstance {
	...
	protected async _createXterm(): Promise<XtermTerminal> {
		...
		const xterm = this._scopedInstantiationService.createInstance(XtermTerminal, Terminal, this._configHelper, this._cols, this._rows, this.target || TerminalLocation.Panel, this.capabilities);
		this.xterm = xterm;
