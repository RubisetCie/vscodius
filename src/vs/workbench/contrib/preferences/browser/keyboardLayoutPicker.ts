...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in VSCodius in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open VSCodius and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
