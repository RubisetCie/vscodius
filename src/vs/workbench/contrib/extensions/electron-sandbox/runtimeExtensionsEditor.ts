...
export class RuntimeExtensionsEditor extends AbstractRuntimeExtensionsEditor {
	...
	constructor(
		...
		super(group, themeService, contextKeyService, extensionsWorkbenchService, extensionService, notificationService, contextMenuService, instantiationService, storageService, labelService, environmentService, clipboardService, extensionFeaturesManagementService);
