...
import { IExtensionManifest, ExtensionType, IExtension as IPlatformExtension, TargetPlatform, IExtensionIdentifier } from 'vs/platform/extensions/common/extensions';
