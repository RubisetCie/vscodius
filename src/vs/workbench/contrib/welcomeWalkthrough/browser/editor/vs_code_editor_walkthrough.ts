...
The core editor in VSCodius is packed with features.  This page highlights a number of them and lets you interactively try them out through the use of a number of embedded editors.  For full details on the editor features for VSCodius and more head over to our [documentation](command:workbench.action.openDocumentationUrl).
