...
import { DEFAULT_MAX_SEARCH_RESULTS, deserializeSearchError, FileMatch, IAITextQuery, IFileMatch, IFileQuery, IFolderQuery, IProgressMessage, ISearchComplete, ISearchProgressItem, ISearchQuery, ISearchResultProvider, ISearchService, isFileMatch, isProgressMessage, ITextQuery, pathIncludedInQuery, QueryType, SEARCH_RESULT_LANGUAGE_ID, SearchProviderType } from 'vs/workbench/services/search/common/search';
