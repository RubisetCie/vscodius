...
declare module 'vscode' {
	...
	export namespace env {
		 ...
		 */
		export const isTelemetryEnabled: boolean;  // Extension compatibility!

		/**
		 * An {@link Event} which fires when the user enabled or disables telemetry.
		 * `true` if the user has enabled telemetry or `false` if the user has disabled telemetry.
		 */
		export const onDidChangeTelemetryEnabled: Event<boolean>;  // Extension compatibility!
		 ...
		 */
		export function createTelemetryLogger(sender: TelemetrySender, options?: TelemetryLoggerOptions): TelemetryLogger;  // Extension compatibility!
